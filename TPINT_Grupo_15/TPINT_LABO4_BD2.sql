...
select descripcion_Loc from Localidades where IdProvincia_Loc=01;
...
CREATE TABLE TiposCuentas (
    IdTipoCuenta_Tc INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE Cuentas (
    NumeroCuenta_Cu VARCHAR(12) PRIMARY KEY,
    ...
    Estado_Cu BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE Prestamos (
	...
	NumeroCuenta_Pr VARCHAR(12) NOT NULL,
