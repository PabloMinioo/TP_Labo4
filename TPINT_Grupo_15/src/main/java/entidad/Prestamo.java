...
public class Prestamo {
    ...
    public Prestamo(int idPrestamo, String dniCliente, int numeroCuenta,
            LocalDate fecha, BigDecimal importeTotal, BigDecimal importeSolicitado,
            int plazoMeses, BigDecimal montoMensual, String cuotas, String estado) throws ImporteInvalidoException, MontoCuotaInvalido {
...
this.estado            = estado;
    ...
    public void setImporteTotal(BigDecimal it)     { this.importeTotal = it; }

    public BigDecimal getImporteSolicitado()       { return importeSolicitado; }
    public void setImporteSolicitado(BigDecimal is){ this.importeSolicitado = is; }
    ...
    public void setMontoMensual(BigDecimal mm)     { this.montoMensual = mm; }
