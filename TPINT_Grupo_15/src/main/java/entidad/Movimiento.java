...
public class Movimiento {
	...
	public Movimiento(int IDMovimiento, Date Fecha, String Detalle, BigDecimal Importe, int NumeroCuenta,
			TipoMovimiento tipoMovimiento, BigDecimal SaldoAnterior, BigDecimal SaldoPosterior, int CuentaDestino)
	...
	public String toString() {
		return "Movimiento [IDMovimiento=" + IDMovimiento + ", Fecha=" + Fecha + ", Detalle=" + Detalle
				+ ", Importe=" + Importe + ", NumeroCuenta=" + NumeroCuenta + ", tipoMovimiento="
				+ tipoMovimiento + ", SaldoAnterior=" + SaldoAnterior + ", SaldoPosterior=" + SaldoPosterior
				+ ", CuentaDestino=" + CuentaDestino + "]";
	}
}
