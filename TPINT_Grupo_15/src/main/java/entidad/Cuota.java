...
public class Cuota {
	...
	public Cuota(int IdCuota, int IdPrestamo, int NroCuenta, int NroCuota, Date FechaVencimiento, BigDecimal MontoCuota,
	...
	public String toString() {
		return "Cuota [IdCuota=" + IdCuota + ", IdPrestamo=" + IdPrestamo + ", NroCuenta=" + NroCuenta + ", NroCuota="
				+ NroCuota + ", FechaVencimiento=" + FechaVencimiento + ", MontoCuota=" + MontoCuota + ", Estado="
				+ Estado + "]";
	}
