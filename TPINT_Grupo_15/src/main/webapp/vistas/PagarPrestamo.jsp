			...
			<tbody>
				...
				<tr>
				  <form action="PrestamoServlet" method="post">
				    ...
				    <input type="hidden" name="idPrestamo" value="<%= cu.getIdPrestamo() %>">
				    <input type="hidden" name="nroCuentaPrestamo" value="<%= cu.getNroCuenta() %>">
				    ...
				    <td>
				      <select name="cuentaDebitar" required>
				        ...
				        %>
				          <option value="<%= c.getNumeroCuenta() %>">cuenta: <%= c.getNumeroCuenta() %> - saldo: $<%= c.getSaldo() %></option>
				        <%
				            }
				          }
				        %>
